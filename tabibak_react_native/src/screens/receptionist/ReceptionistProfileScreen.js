  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerRole}>موظف الاستقبال</Text>
      ...
      >
        ...
        <InfoRow icon="briefcase-outline" label="الدور"      value="موظف الاستقبال" />
...
const styles = StyleSheet.create({
  ...
  headerRole: { fontSize: FontSizes.md, color: 'rgba(255,255,255,0.9)', marginBottom: Spacing.xs },
